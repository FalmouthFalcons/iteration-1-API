...
class TrainingProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training_program" do
    assert_difference('TrainingProgram.count') do
      post training_programs_url, params: { training_program: { end_date: @training_program.end_date, max_occupancy: @training_program.max_occupancy, start_date: @training_program.start_date, subject: @training_program.subject } }, as: :json
    end
