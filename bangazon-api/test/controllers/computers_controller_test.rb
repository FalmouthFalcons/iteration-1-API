...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { decomission_date: @computer.decomission_date, purchase_date: @computer.purchase_date } }, as: :json
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { decomission_date: @computer.decomission_date, purchase_date: @computer.purchase_date } }, as: :json
    assert_response 200
  end
